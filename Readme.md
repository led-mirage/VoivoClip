...
声の高さの設定です。アプリのGUIで設定できます。

#### ✨ intonation_scale（既定値 1.0）

声の抑揚の設定です。アプリのGUIで設定できます。

#### ✨ volume_scale（既定値 1.0）

声の音量の設定です。アプリのGUIで設定できます。

#### ✨ pre_phoneme_length（既定値 0.1）

音声の前の無音時間（秒）の設定です。アプリのGUIで設定できます。

#### ✨ post_phoneme_length（既定値 0.1）

音声の後の無音時間（秒）の設定です。アプリのGUIで設定できます。

#### ✨ pause_length（既定値 null）

句読点などの無音時間（秒）の設定です。`null` の場合はVOICEVOX側の既定値を使用します。アプリのGUIで設定できます。

#### ✨ pause_length_scale（既定値 1.0）

句読点などの無音時間の倍率設定です。アプリのGUIで設定できます。
